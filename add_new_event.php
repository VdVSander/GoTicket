        ...
        <div class="d-flex justify-content-center form_container">
          <form action="includes/signin.php" method="POST" id="form">
            <div class="input-group mb-3">
              ...
              <input type="text" name="event_name" id="event_name" class="form-control input_user" placeholder="evenementnaam" required>
            </div>
            <div class="input-group mb-2">
              <div class="input-group-append">
                <span class="input-group-text"> <img src="open-iconic-master/png/key-2x.png" alt="key"> </span>
              </div>
              <input type="text" name="address" id="address" class="form-control input_pass" placeholder="Adres" required>
            </div>
            <div class="input-group mb-2">
              <div class="input-group-append">
                <span class="input-group-text"> <img src="open-iconic-master/png/key-2x.png" alt="key"> </span>
              </div>
              <input type="text" name="city" id="city" class="form-control input_pass" placeholder="Stad" required>
            </div>
            <div class="input-group mb-2">
              <div class="input-group-append">
                <span class="input-group-text"> <img src="open-iconic-master/png/key-2x.png" alt="key"> </span>
              </div>
              <input type="number" name="postalcode" id="postalcode" class="form-control input_pass" placeholder="Postcode" required>
            </div>
            <div class="input-group mb-2">
              <div class="input-group-append">
                <span class="input-group-text"> <img src="open-iconic-master/png/key-2x.png" alt="key"> </span>
              </div>
              <input type="text" name="location" id="location" class="form-control input_pass" placeholder="Locatie">
            </div>
            <div class="input-group mb-2">
              <div class="input-group-append">
                <span class="input-group-text"> <img src="open-iconic-master/png/key-2x.png" alt="key"> </span>
              </div>
              <input type="date" name="start_date" id="start_date" class="form-control input_pass" placeholder="Startdatum" required>
            </div>
            <div class="input-group mb-2">
              <div class="input-group-append">
                <span class="input-group-text"> <img src="open-iconic-master/png/key-2x.png" alt="key"> </span>
          ...
          <button type="submit" name="event-submit" class="btn btn-primary">Toevoegen</button>
           </div>
          </form>
        </div>
